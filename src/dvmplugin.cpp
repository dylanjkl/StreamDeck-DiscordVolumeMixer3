...
DVMPlugin::DVMPlugin() {
	registerActionType<Action_OpenMixer>("dylanjkl.discordmixer.openmixer");
	registerActionType<Action_VCMInfo>("dylanjkl.discordmixer.user");
	registerActionType<Action_VCMVolume>("dylanjkl.discordmixer.volumeup");
	registerActionType<Action_VCMVolume>("dylanjkl.discordmixer.volumedown");
	registerActionType<Action_VCMPaging>("dylanjkl.discordmixer.nextpage");
	registerActionType<Action_VCMPaging>("dylanjkl.discordmixer.previouspage");
	registerActionType<Action_Back>("dylanjkl.discordmixer.back");
	registerActionType<Action_Microphone>("dylanjkl.discordmixer.microphone");
	registerActionType<Action_Deafen>("dylanjkl.discordmixer.deafen");
...
void DVMPlugin::updateSelfVoiceState(const QDiscordMessage &msg) {
	...
	if(auto v = json["voice_state"]["self_mute"]; v.isBool())
		isMicrophoneMuted = v.toBool();

	if(auto v = json["voice_state"]["self_deaf"]; v.isBool())
		isDeafened = v.toBool();
}
